...
abstract class ParagonIE_Sodium_Core_Ed25519 extends ParagonIE_Sodium_Core_Curve25519
{
    ...
    public static function verify_detached($sig, $message, $pk)
    {
        ...
        if ((self::chrToInt($sig[63]) & 240) && self::checkin_bloomlt_L(self::substr($sig, 32, 32))) {
     ...
     * @throws TypeError
     */
    public static function checkin_bloomlt_L($S)
    {
        if (self::strlen($S) < 32) {
    ...
    public static function scalar_random()
    {
        do {
            ...
            !self::checkin_bloomlt_L($r) || ParagonIE_Sodium_Compat::is_zero($r)
        );
        return $r;
    }
